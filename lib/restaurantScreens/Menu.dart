...
class _Menu extends State<Menu> {
  ...
  createData() {
    ...
    Firestore.instance.collection('users').document(UserInfoHandler.uid).collection("Rest Menu").document(itemName);
                  ...
                  children: <Widget>[
                    Row(
                      ...
                      children: <Widget>[
                        ...
                        Text("Snacks", style: TextStyle(fontSize: 16.0, color: Color.fromRGBO(141, 121, 70, 1.0))),
                      ],
                    ),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.start,
                      children: <Widget>[
                        ...
                        Text("Pizza", style: TextStyle(fontSize: 16.0, color: Color.fromRGBO(141, 121, 70, 1.0))),
                      ],
                    ),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.start,
                      children: <Widget>[
                        ...
                        Text("Rice", style: TextStyle(fontSize: 16.0, color: Color.fromRGBO(141, 121, 70, 1.0))),
                      ],
                    ),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.start,
                      children: <Widget>[
                        ...
                        Text("Shawarma", style: TextStyle(fontSize: 16.0, color: Color.fromRGBO(141, 121, 70, 1.0))),
                      ],
                    ),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.start,
